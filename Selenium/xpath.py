...
# Sintaxes do XPath
# Não utilizar o *, sempre tentar achar a tag especifica.
# //nomedatag[@atributo='']
# //*[contains(text(),'Exemplo')]
# //*[contains(text(),'Exemplo') or contains(text(),'Teste')]
# //*[contains(text(),'Exemplo') and contains(text(),'Teste')]
# //*{[starts-with(@class,'teste')]

# Xpath no VsCode
# driver.find_element(By.XPATH,"//nomedatag[@atributo='']")
